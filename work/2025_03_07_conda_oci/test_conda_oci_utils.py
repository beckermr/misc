...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1.0.0!1", "1.0.0_N1"),
        ("1.0.0=1", "1.0.0_E1"),
        ("1.0.0+1_1", "1.0.0_P1_U1"),
        ("1.0.0+1!1", "1.0.0_P1_N1"),
        ("1.0.0_+1_1", "1.0.0_U_P1_U1"),
        ("blah:foo/fgh bar\tgoo", "blah_Cfoo_Sfgh_Bbar_Tgoo"),
        ("blah_\r\n:foo/fgh bar\tgoo", "blah_U_R_L_Cfoo_Sfgh_Bbar_Tgoo"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("foo-1.0.0_1-0", "cfoo:1.0.0_U1-0"),
        ("foo-1.0.0+1-h34243_0", "cfoo:1.0.0_P1-h34243_U0"),
        ("foo-1.0.0!1-h34243_0", "cfoo:1.0.0_N1-h34243_U0"),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "conda-forge/linux-64/cgdal:2.3.3-py27hf242f0b_U1-test",
        ),
        (
        ...
        (
            ...
            "conda-forge/linux-64/cgdal:2.3.3-py27hf242f0b_U1",
        ),
        (
        ...
        (
            ...
            "conda-forge/linux-64/h42d944d006b5831a1be5e7456647dbbb0c497135:hca23559213e5d3ae63dcc1eb40b2b8d0dab681df",
        ),
        (
            "conda-forge/linux-64/g" + "-" + "2" * 300 + "2.3.3-py27hf242f0b_1",
            "conda-forge/linux-64/hbb0b6647e93b6fb3593e649f301d6c4b49990a8a:hb975f6bad18d1a8a3ce5e73730aabc993cbbc066",
        ),
    ],
)
